...
if (isset($_POST['submit'])) {
    // Panggil fungsi addKategori() untuk menyimpan data
    $data = [
        'nama_kategori' => $_POST['nama_kategori']
    ];

    $result = addKategori($data);
...
// Query untuk mengambil data kategori dari tabel
...
?>
    ...
    ?>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#insertKategori">
                                Insert Kategori
                            </button>
                        </div>
                    </div>
    ...
    <tr>
        ...
        <td>
            <!-- Icon edit -->
            <a href="#" data-bs-toggle="modal" data-bs-target="#editModal<?php echo $row['kategori_id']; ?>"><i class="fas fa-edit"></i></a>
          <!-- Icon hapus -->
    <a href="#" onclick="confirmDelete(<?php echo $row['kategori_id']; ?>)"><i class="fas fa-trash"></i></a>
        </td>
    </tr>

    <!-- Modal Edit Kategori -->
    <div class="modal fade" id="editModal<?php echo $row['kategori_id']; ?>" tabindex="-1" aria-labelledby="editModalLabel<?php echo $row['kategori_id']; ?>" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-dark text-white">
                    <h5 class="modal-title" id="editModalLabel<?php echo $row['kategori_id']; ?>">Edit Kategori</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body bg-dark text-white">
                    <form action="edit_kategori.php?id=<?php echo $row['kategori_id']; ?>" method="post">
                        <div class="mb-3">
                            <label for="editNamaKategori" class="form-label">Nama Kategori</label>
                            <input type="text" class="form-control" id="editNamaKategori" name="editNamaKategori" value="<?php echo $row['nama_kategori']; ?>">
                        </div>
...
<!-- Modal for Insert Kategori -->
<div class="modal fade" id="insertKategori" tabindex="-1" aria-labelledby="insertKategori" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-dark text-white">
                    <h5 class="modal-title" id="insertKategori">Insert Kategori</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body bg-dark text-white">
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
    ...
    <script>
    // Fungsi untuk menampilkan dialog konfirmasi sebelum menghapus kategori
    function confirmDelete(id) {
        // Tampilkan dialog konfirmasi
        var result = confirm("Apakah Anda yakin ingin menghapus kategori ini?");
        // Jika pengguna menekan tombol OK
        if (result) {
            // Redirect ke halaman delete_kategori.php dengan menyertakan ID kategori yang akan dihapus
